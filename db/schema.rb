...
ActiveRecord::Schema.define(version: 20140701180513) do
  ...
  add_index "following_relationships", ["follower_id", "followed_user_id"], name: "following_relationships_unique_ids", unique: true, using: :btree
